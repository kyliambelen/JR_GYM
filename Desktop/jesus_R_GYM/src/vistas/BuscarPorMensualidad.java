 ...
 */
public class BuscarPorMensualidad extends javax.swing.JDialog {

    UIManager UI;
    @SuppressWarnings("FieldMayBeFinal")
    private Conexion conexion = new Conexion();

    public BuscarPorMensualidad(Operaciones_mensualidad REMC, boolean modal) {
        super(REMC, modal);
        initComponents();
        mostrarTabla();
    }
    ...
    private void initComponents() {
        ...
        TableBuscar.setFont(new java.awt.Font("Arial", 1, 12)); // NOI18N
        TableBuscar.setForeground(new java.awt.Color(51, 51, 51));
    ...
    private void TableBuscarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_TableBuscarMouseClicked
        ...
        /* FUNCION  PARA  SELECCIONAR  CON UN CLICK  EL ATLETA  Y  PASAR  EL  PARAMETRO  AL CAMPO CEDULA DE reporteMensualidad_cedula  */
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BuscarPorMensualidad.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            @Override
            public void run() {
                BuscarPorMensualidad dialog = new BuscarPorMensualidad((Operaciones_mensualidad) new javax.swing.JFrame(), true);
    ...
    ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    /*  FUNCION  PARA  MOSTRAR  LA  TABLA  CON  LOS  CODOGOS */
    public void mostrarTabla() {
        try {
            ...
            String sql = "SELECT idmensualidad,cedula,nombres FROM mensualidad";
